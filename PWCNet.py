...
class PWCDCNet_half(nn.Module):
    ...
    def __init__(self, md=4):
        ...
        """
        super(PWCDCNet_half, self).__init__()

        self.corr = Correlation(pad_size=md, kernel_size=1, max_displacement=md, stride1=1, stride2=1, corr_multiply=1)
        # self.corr = correlation.FunctionCorrelation
        # self.corr = SpatialCorrelationSampler(3, 3, 2, 1, 2)
    ...
    def forward(self, c12, c22, c13, c23, c14, c24, c15, c25, c16, c26):
...
class PWCDCNet_encoder(nn.Module):
    """
    PWC-DC net. add dilation convolution and densenet connections
    ...
    def __init__(self, md=4):
        ...
        """
        super(PWCDCNet_encoder, self).__init__()
